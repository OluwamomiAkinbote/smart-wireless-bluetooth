...
export const metadata = {
  ...
  description: 'Smart Wireless-Bluetooth 5.3 headset with noise canceling mic, LED display, 100H battery life, ergonomic fit, and dual-device connection for seamless work and calls.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Upgrade your calls and music with Smart Wireless-Bluetooth 5.3 headset featuring LED display, 100H battery, noise canceling mic, and ergonomic all-day comfort.',
    ...
    <html lang="en">
      <head>
        ...
        <script>
          ...
          fbq('init', '1969926893847925');
          fbq('track', 'PageView');`}
        </script>
        
        <noscript>
          <img height="1" width="1" style={{display:'none'}}
            src="https://www.facebook.com/tr?id=1969926893847925&ev=PageView&noscript=1"
            alt="" />
        </noscript>
      </head>
